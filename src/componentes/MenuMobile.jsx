...
function MenuMobile(props){
  ...
  <div className={`menuMobile ${isOpenMenuMobile && 'menuMobile--open'}`}>
    ...
    <ul>
      <li onClick={toggleProfileMenu}>
        ...
        <ul className={isOpenProfileMenu ? 'show' : ''}>
          <li>
            <Link className="menuMobile__option" onClick={openMenuMobile} to='/profile/settings'>
          ...
          <li>
            <Link className="menuMobile__option" onClick={openMenuMobile} to='/profile/products' >
              <img className='menuMobile__optionIcon' src={home} alt="" />
    ...
    <span onClick={openMenuMobile}></span>
