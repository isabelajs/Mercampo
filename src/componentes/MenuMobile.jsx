...
function MenuMobile(props){
  ...
  const {isOpenMenuMobile,openMenuMobile} = props
  ...
  <div className={`menuMobile ${isOpenMenuMobile && 'menuMobile--open'}`}>
    ...
    <svg onClick={openMenuMobile} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <ul>
        ...
        <ul className={isOpenProfileMenu && 'show'}>
          <li>
            <div className="menuMobile__option">
              ...
              <Link className='menuMobile__optionTitle' to='/profile/settings' >Settings</Link>
            </div>
          </li>
          ...
          <li>
            <div className="menuMobile__option">
              <img className='menuMobile__optionIcon' src={home} alt="" />
              <Link className='menuMobile__optionTitle' to='/profile/products' >My Products</Link>
            </div>
          </li>
        </ul>
      </li>
      ...
      <li>
        <div className="menuMobile__option">
          <img className='menuMobile__optionIcon' src={home} alt="" />
          <Link className='menuMobile__optionTitle' to='/' >Home</Link>
        </div>
      </li>
      ...
      <li>
        <div className="menuMobile__option">
          <img className='menuMobile__optionIcon' src="" alt="" />
          <Link className='menuMobile__optionTitle' to='/products' >Productos</Link>
        </div>
      </li>
      ...
      <li>
        <div className="menuMobile__option">
          <img className='menuMobile__optionIcon' src="" alt="" />
          <Link className='menuMobile__optionTitle' to='/contact' >About Us</Link>
        </div>
      </li>
    </ul>

    <div className='menuMobile__login'>Log In</div>
