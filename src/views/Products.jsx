...
export default function Products() {
	...
	const [statusPrevious, setStatusPrevious] = useState(false)
	...
	const visibilityArrows =  useCallback(()=>{
		...
		const realScrollWidth = refCategories.current.scrollWidth - refCategories.current.offsetWidth

		refCategories.current.scrollLeft > 0 ? setStatusPrevious(true) : setStatusPrevious(false)

		refCategories.current.scrollLeft < realScrollWidth ? setStatusNext(true) : setStatusNext(false)
      ...
      <div className="c-products__tools">
        <div className="products__tools">
            ...
            <div className="search">		
							<svg className='search__icon' width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="products__categories">
					<div className='button--arrow'>
						{ statusPrevious && 	<div className='arrow arrow--previous'onClick={moveLeftScroll}>
						...
						{ statusNext && <div className="arrow arrow--next" onClick = {moveRightScroll}>
					...
					<div className='categories'  ref={refCategories} onScroll={handleScroll}>
